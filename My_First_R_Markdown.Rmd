...
extracting subsets of R objects  
 ...
 - S is used to extract elements of a list or dataframe by name. Similar to using [[  
```{r}
x <- c("a", "b", "c", "c", "d", "a")
x[1]
x[2]
...
Many operations in % are *vectorised*, making code more efficient, concise and easier to read.  
```{r}
x <- 1:4; y <- 6:9
x + y  ## ass 1st element of x to 1st element of y, 2nd to 2nd, etc.
